...
const SET_USER_DATA = 'loremail/auth/SET_USER_DATA';
const GET_CAPTCHA_URL_SUCCESS = 'loremail/auth/GET_CAPTCHA_URL_SUCCESS';
...
export const getCaptchaUrl = () => async (dispatch) => {
    ...
    const captchaUrl = response.data.url;
        dispatch(getCaptchaUrlSuccess(captchaUrl)) // если resultCode === 0 то диспатчим данные в редьюсер
